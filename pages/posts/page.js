    ...
    <Format>
      <section className="container mx-auto md:px-2 py-16 w-1/2">
        ...
        <div className="post py-10">
          ...
          <p className="text-gray-500 text-xl text-center">Far far away, behind the world mountains, far from the contries Vokalia and Consonantia, there live the blind texts.</p>

          <div className="py-10">
            <Image alt="" src={"/images/img1.jpg"} width={900} height={600}></Image>
          </div>
